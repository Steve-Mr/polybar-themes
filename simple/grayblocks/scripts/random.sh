...
# Color files
PFILE="$HOME/.config/polybar/polybar-themes/simple/grayblocks/colors.ini"
RFILE="$HOME/.config/polybar/polybar-themes/simple/grayblocks/scripts/rofi/colors.rasi"
