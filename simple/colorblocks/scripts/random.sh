...
# Color files
PFILE="$HOME/.config/polybar/polybar-themes/simple/colorblocks/colors.ini"
RFILE="$HOME/.config/polybar/polybar-themes/simple/colorblocks/scripts/rofi/colors.rasi"
